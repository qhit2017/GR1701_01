...
insert into tb_emp(ename,deptno,job,sal,hiredate,sex) 
values('沈丽',10,'经理',4000,'2017-01-25','woman'),
('张小丽',30,'保洁工',3000,'2017-01-25','woman')
...
select ename ,count(*)as 重复条数 from tb_emp group by ename having COUNT(*)>=2
